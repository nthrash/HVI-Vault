# protocols-lvad-pulsatility-index
...
- $(Power_{max} = 4.7\ \text6)$ (systole is weaker than before)
- $(Power_{min} = 3.9\ \text6)$ (diastolic flow is also down)
- ($Power_{avg} = 4.3\ \text6)$
...
Let’s say, in this short window:
	...
	- $(Power_{max} \approx 4.6\ \text6)$ (similar to the previous hypovolemic state)
- But **on a suction beat**, diastolic/inflow power **plummets**:
	- $(Power_{min} \approx 3.0\ \text6)$ (instead of ~3.9 W
