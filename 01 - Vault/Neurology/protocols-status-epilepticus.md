---
title: "Management of Seizures and Status Epilepticus"
...
- Metabolic/toxic: hypoglycemia, hyponatremia (and rapid correction), hypocalcemia, hepatic or uremic encephalopathy, hyperthermia
- Withdrawal: alcohol, benzodiazepine, barbiturate withdrawal
- Toxic/drug-induced: sympathomimetics, bupropion, tramadol, isoniazid (INH), theophylline, cyclic antidepressants, flumazenil in benzodiazepine-dependent patients
- Infectious/inflammatory: meningitis, encephalitis (especially HSV and autoimmune/anti-NMDA-receptor encephalitis), abscess
- Structural/traumatic: traumatic brain injury, tumor, subdural/epidural hematoma
- Hypoxic-ischemic injury (post-cardiac arrest)

**Remote symptomatic causes** — SE occurring in a patient with a pre-existing epileptogenic lesion (prior stroke, prior TBI, cortical malformation), often precipitated by a secondary trigger such as **antiseizure medication (ASM) non-adherence** — the single most common precipitant of SE in known epileptics.

**Progressive symptomatic:** neurodegenerative disease, CNS malignancy, progressive metabolic disorders.
...
**Trigger → mechanism.** With ongoing seizure activity, postsynaptic GABA-A receptors are rapidly internalized (endocytosed) from the synaptic membrane into intracellular pools, while excitatory NMDA and AMPA receptors are simultaneously trafficked *to* the synaptic surface. The practical consequence is a receptor-level "double hit": the brain becomes progressively less responsive to GABAergic drugs (benzodiazepines) and simultaneously more excitable via glutamatergic mechanisms, the longer seizures continue.

**Clinical consequence — time-dependent pharmacoresistance.** This is why benzodiazepine efficacy falls sharply the longer SE has been running before treatment: a drug that would abort a seizure at minute 5 may be far less effective at minute 45, because the molecular target itself has changed. It is also the physiologic rationale for combining a GABAergic agent (benzodiazepine) with a second-line drug acting on a different mechanism (sodium channel blockade — phenytoin/fosphenytoin; broader multi-channel effects — valproate, levetiracetam) rather than simply repeating benzodiazepine doses.

**Systemic consequences.** SE is not confined to the brain. An early **compensated phase** (roughly the first 30 minutes) features a catecholamine surge with hypertension, tachycardia, hyperglycemia, and adequate cerebral perfusion despite the massive increase in cerebral metabolic demand. Beyond ~30–60 minutes, patients enter a **decompensated phase**: autoregulation fails, hypotension develops, hypoglycemia may occur as glycogen stores deplete, lactic acidosis worsens, hyperthermia develops from sustained motor activity, and rhabdomyolysis, aspiration, and cardiac arrhythmias may follow. At the cellular level, sustained excitotoxic calcium influx through NMDA receptors drives neuronal injury independent of systemic hypoxia or hypotension — meaning **SE causes brain injury even when oxygenation and blood pressure are maintained**, purely through excitotoxicity. This is why the treatment goal is electrographic and clinical seizure termination, not merely hemodynamic stabilization.
...
*Convulsive SE:* generalized tonic-clonic activity — tonic stiffening followed by rhythmic clonic jerking, loss of consciousness, tongue biting, urinary incontinence, apnea/cyanosis during the tonic phase. As SE progresses, convulsive movements may become subtle — flickering eyelid movements, nystagmoid eye deviation, or focal twitching of a digit — while the underlying electrographic seizure continues (a red flag for NCSE, not resolution).

*Non-convulsive SE:* altered mental status ranging from subtle confusion to coma, without prominent motor activity. Presentations include unexplained fluctuating consciousness, staring spells, automatisms (lip smacking, picking movements), aphasia, or unexplained failure to return to baseline mental status after a convulsive seizure.

*Focal SE (with or without impaired awareness):* may present as prolonged focal motor activity (epilepsia partialis continua), aphasia, or behavioral arrest without generalization.

**History pearls**
- Establish a precise seizure-onset time — this is the single most decision-relevant piece of history, as it anchors the T1/T2 treatment clock.
- ASM history and adherence, recent dose changes, and last known ASM level if available.
- Alcohol/substance use and withdrawal timing.
- Fever, recent infection, immunosuppression, travel/exposure history (infectious encephalitis).
- Prior epilepsy history, prior SE episodes, and known epileptogenic lesion.
- Pregnancy status in women of childbearing age (eclampsia as a specific etiology and driver of management, e.g., magnesium).
- Head trauma, anticoagulation status, and recent neurosurgical history.

**Physical exam findings**
- Vital sign derangement pattern: early hyperthermia, tachycardia, and hypertension (compensated phase) versus later hypotension and hypoxia (decompensated phase) — trend, don't just spot-check.
- Signs of trauma from convulsions (tongue laceration, posterior shoulder dislocation, vertebral compression fractures).
- Focal neurologic deficits suggesting a structural lesion (Todd's paralysis can mimic a new stroke post-ictally and should prompt reassessment rather than immediate thrombolysis workup if a clear seizure was witnessed).
- Meningismus, papilledema, or rash suggesting infectious/inflammatory etiology.
- Subtle motor findings (nystagmus, twitching of a finger or eyelid) in a persistently unresponsive patient — the exam finding that should trigger emergent EEG.

**Red flags**
- Any convulsive seizure activity, continuous or repeated without return to baseline, lasting ≥5 minutes — treat as SE; do not wait for the traditional 30-minute definition.
- Failure to regain consciousness within 20–30 minutes after convulsions stop — presume NCSE until proven otherwise with EEG.
- Hemodynamic instability, hyperthermia >40°C, or signs of impending respiratory failure.
...
**Point-of-care/immediate:** fingerstick glucose (treat hypoglycemia immediately — it is rapidly reversible and a common precipitant), pulse oximetry, continuous cardiac monitoring.

**Laboratory studies**
- Basic metabolic panel (sodium is the electrolyte most commonly implicated), calcium, magnesium, phosphate
- CBC (infection, leukocytosis from stress response)
- ASM levels if patient is on known agents (phenytoin, valproate, levetiracetam, carbamazepine, phenobarbital)
- Toxicology screen and blood alcohol level
- Liver and renal function (relevant to both etiology and drug dosing/selection)
- Ammonia if hepatic encephalopathy suspected
- Creatine kinase if prolonged convulsions (rhabdomyolysis)
- Arterial or venous blood gas and lactate (assess acidosis, ventilatory status)
- Pregnancy test in women of childbearing age
- Lumbar puncture if infectious or inflammatory etiology suspected (after imaging if mass effect is a concern, or empiric antimicrobials first if LP delayed)

**Imaging**
- Non-contrast head CT emergently in any first-time SE, focal findings, trauma, anticoagulation, or when etiology is unclear — to exclude hemorrhage, mass, or herniation risk before LP.
- MRI brain (with contrast) once stabilized — superior sensitivity for encephalitis, subtle structural lesions, hippocampal signal change from SE itself, and post-ictal changes; obtain electively rather than delaying acute treatment.

**Special testing**
- **Continuous EEG (cEEG)** is the standard of care for any SE patient who does not rapidly return to baseline mental status after convulsions stop, and for any patient requiring pharmacologic paralysis or continuous anesthetic infusion (where clinical exam is unreliable). Ideally within 1 hour of SE onset if NCSE is suspected; cEEG monitoring is typically continued for at least 24–48 hours (longer in comatose patients) given the risk of recurrent electrographic seizures.
...
Give a full, weight-based dose immediately — under-dosing is the most common and most consequential error in SE management.

| Agent | Route | Dose | Notes |
|---|---|---|---|
| Lorazepam | IV | 0.1 mg/kg (max 4 mg/dose), may repeat once | Preferred IV agent (RAMPART comparator); onset ~2–3 min |
| Midazolam | IM | 10 mg (≥40 kg) / 5 mg (13–40 kg) | Preferred when no IV access (RAMPART); also effective buccal/intranasal |
| Diazepam | IV or PR | 0.15–0.2 mg/kg IV (max 10 mg), or 0.2–0.5 mg/kg PR | Shorter CNS duration than lorazepam due to redistribution; rectal gel useful when no access |

If seizures persist 5 minutes after the first dose, give the repeat/second dose without delay.
...
|---|---|---|---|
| Levetiracetam | 60 mg/kg IV (max 4,500 mg) | Renal/hepatic dysfunction, need for rapid infusion, minimal drug interactions, pregnancy | Dose-adjust for renal impairment |
| Fosphenytoin | 20 mg PE/kg IV (max 1,500 mg PE) | Known sodium-channelopathy-responsive epilepsy | Cardiac conduction disease, hypotension, elderly (infusion-related arrhythmia/hypotension); avoid in porphyria |
| Valproate | 40 mg/kg IV (max 3,000 mg) | Idiopathic generalized epilepsy, myoclonic seizures | Hepatic disease, mitochondrial disease, pregnancy (teratogenic), thrombocytopenia, hyperammonemia |
...
**Special populations**
- **Eclampsia:** magnesium sulfate (4–6 g IV load, then 1–2 g/hr) is first-line, not a standard ASM; delivery is definitive treatment.
- **Pregnancy (non-eclamptic SE):** levetiracetam favored given the most favorable teratogenicity profile among second-line agents; avoid valproate.
- **Renal impairment:** favor levetiracetam with dose adjustment; use caution with agents cleared/protein-bound in ways altered by uremia (phenytoin free-fraction rises).
- **Hepatic impairment:** avoid valproate; levetiracetam requires minimal hepatic metabolism and is preferred.
- **Elderly:** more susceptible to fosphenytoin-related hypotension/arrhythmia and to oversedation from anesthetic agents; lower seizure threshold for treatment given comorbidity burden.
- **Alcohol withdrawal seizures:** benzodiazepines remain first-line and often sufficient; consider phenobarbital in refractory alcohol-withdrawal SE given its efficacy in withdrawal states.
- **Isoniazid toxicity:** give pyridoxine (vitamin B6), which is often required in addition to standard therapy for seizures to resolve.
...
> - **A patient who "seized then never woke up" has NCSE until an EEG says otherwise.** Don't attribute prolonged unresponsiveness to "post-ictal state" beyond 20–30 minutes without electrographic confirmation.
> - **The clinical exam becomes unreliable once you've paralyzed the seizure, not necessarily the brain.** Subtle motor SE can persist electrographically after convulsions stop on the surface — this is why cEEG, not the bedside exam, drives titration of anesthetic infusions.
> - **Don't chase "SE resolution" by hemodynamic stability alone.** Excitotoxic injury proceeds independent of blood pressure and oxygenation — the goal is seizure termination, not just a normal vital sign panel.
> - **ESETT freed you from having to guess "the right" second-line drug** — levetiracetam, fosphenytoin, and valproate are roughly equivalent in efficacy; choose based on comorbidities (renal/hepatic disease, pregnancy, cardiac conduction disease, epilepsy syndrome) rather than dogma.
> - **Check the glucose and get an ASM level early** — two of the fastest, cheapest interventions that can immediately reframe the entire workup.
