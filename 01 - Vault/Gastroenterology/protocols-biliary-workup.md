...
| Scenario                                            | Early Phase                                                                                                                                                                       | Late Phase                                                                                                                                                                                      | Mechanism / Why                                                                                                                                              |
| --------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Ischemic hepatitis (shock liver)**                | GGT **normal**. AST/ALT spike massively (often 10–20× ULN) within 1–3 days; LDH high with low ALT/LDH ratio (<1.5); bilirubin rises modestly and lags.                            | GGT **remains normal**. AST/ALT normalize within ~7–10 days if hemodynamics correct; bilirubin lags behind.                                                                                     | Zone 3 hepatocyte necrosis from hypoxia; canalicular apparatus/bile ducts spared → no bile acid accumulation → no GGT release.                               |
| **Hemolysis (Impella/ECMO)**                        | GGT **normal**. Indirect (unconjugated) bilirubin rises; LDH high; haptoglobin low; plasma free Hgb may rise.                                                                     | GGT **remains normal** if hemolysis is the sole process.                                                                                                                                        | Pre-hepatic bilirubin overproduction; no hepatobiliary injury.                                                                                               |
| **Acute RV failure / acute congestion**             | GGT often **normal or mildly elevated**. AST/ALT rise modestly (usually 2–3× ULN); bilirubin rises from impaired hepatocellular clearance; rarely >3 mg/dL from congestion alone. | GGT **rises over days–weeks** if congestion persists → cholestatic pattern (↑GGT, ↑ALP, ↑bilirubin).                                                                                            | Early: sinusoidal distension with intact canaliculi. Late: sustained venous pressure → canalicular distension → bile stasis → GGT solubilized from membrane. |
| **Chronic congestive hepatopathy**                  | N/A (established)                                                                                                                                                                 | GGT, ALP, and bilirubin **elevated** (cholestatic predominance) with prolonged PT; correlates with JVD, edema, TR severity.                                                                     | Chronic canalicular distension and bile stasis; cholestatic markers exceed transaminase elevations.                                                          |
| **Biliary obstruction (e.g., choledocholithiasis)** | GGT **rises earlier than ALP**; ALP may still be near-normal early. (Exact hour-by-hour kinetics are illustrative, not validated.)                                                | GGT and ALP **markedly elevated** (biliary values often 3–6× higher than in parenchymal disease); GGT declines more slowly than ALP after relief; transaminases may fall while GGT/ALP persist. | Bile acid retention → detergent effect on canalicular membrane; GGT rises earlier and resolves later than ALP.                                               |
| **Sepsis-related cholestasis**                      | GGT **normal or mildly elevated**; conjugated bilirubin rises early.                                                                                                              | GGT and ALP **rise progressively** if cholestasis persists; sustained elevation signals complicated course.                                                                                     | Inflammation downregulates canalicular bile acid/bilirubin transporters (intrahepatic cholestasis), not mechanical obstruction.                              |
| **Drug-induced cholestatic injury**                 | GGT **rises early**, often before ALP; latency typically ~2–12 weeks (varies widely by agent).                                                                                    | GGT **persists longer than ALP** after withdrawal; can remain elevated for months; rarely → vanishing bile duct syndrome.                                                                       | Injury to canalicular transporters/cholangiocytes; GGT correlates with ALP in cholestatic DILI.                                                              |
| **Alcohol use**                                     | GGT **elevated** even without overt liver disease; sensitive marker of intake.                                                                                                    | GGT **remains elevated** with continued use; falls with abstinence (half-life ~2–4 weeks).                                                                                                      | Microsomal enzyme induction (CYP2E1) plus oxidative stress — independent of cholestasis; explains high GGT with normal ALP/bilirubin.                        |
| **NAFLD/NASH**                                      | GGT **mildly elevated** (typically <200 U/L — lowest among major liver diseases).                                                                                                 | GGT **remains mildly elevated**; correlates with ALT, AST, triglycerides — not ALP.                                                                                                             | Oxidative stress and lipid peroxidation, not cholestasis; GGT tracks metabolic rather than cholestatic markers.                                              |
