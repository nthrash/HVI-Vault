### Ventilator Management: A Clinical Reference for the Intensivist

## Overview
This protocol provides a structured approach to initiating, managing, and weaning mechanical ventilation in critically ill adults. It emphasizes lung-protective strategies, systematic troubleshooting, and evidence-based liberation from the ventilator, with considerations relevant to cardiothoracic and heart failure ICU patients.
...
|------|-------------|------------|
| Volume-Controlled Assist Control (VC-AC) | Delivers a set tidal volume with each breath | Default initial mode; guarantees minute ventilation |
| Pressure-Controlled Assist Control (PC-AC) | Delivers breaths to a set inspiratory pressure | Useful when limiting plateau pressures is difficult in VC-AC |
| Pressure Support Ventilation (PSV) | Patient-triggered, pressure-targeted spontaneous mode | Weaning and spontaneous breathing trials |
| SIMV (Volume or Pressure) | Combines mandatory and spontaneous breaths | Less commonly used; may prolong weaning |
