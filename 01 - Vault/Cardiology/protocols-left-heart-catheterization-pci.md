---
title: "Left Heart Catheterization With Percutaneous Coronary Intervention"
subtitle: "CCAPP Learning Topic"
category: "Cardiology"
...
# Left Heart Catheterization With Percutaneous Coronary Intervention
...
In the HVI ICU, the key APP responsibilities are to recognize time-sensitive ischemia, prepare the patient safely, understand the procedural handoff, and rapidly identify access, ischemic, hemorrhagic, renal, and mechanical complications after the procedure. This is an educational reference, not a patient-specific order set; follow local cath-lab protocols and involve the interventional cardiologist early.
...
| --- | --- | --- |
| Arterial access | Radial access is generally preferred for ACS PCI; femoral access is used when radial access is unsuitable or large-bore support is anticipated. | Know the site, sheath size, closure/hemostasis plan, and distal-pulse baseline. |
...
| Clinical setting | Role of angiography/PCI |
| --- | --- |
| STEMI or ischemia with ongoing instability | Emergent angiography and primary PCI when indicated by the local reperfusion pathway. |
| NSTE-ACS | Invasive strategy is based on ischemic risk, recurrent symptoms, hemodynamics, ECG/troponin findings, and competing risks. |
| Chronic coronary syndrome | Defines anatomy and may permit revascularization when symptoms/ischemia persist despite guideline-directed therapy or when anatomy changes management. |
| Cardiogenic shock or post-arrest ischemia | Defines coronary contribution, but decisions require shock-team, neurologic, and overall-goal-of-care context. |
| Structural/hemodynamic question | LV/aortic pressure measurements may clarify aortic stenosis or filling pressures when noninvasive data are inadequate. |

### Relative hazards to address before a non-emergent procedure

- Prior iodinated-contrast reaction, renal dysfunction or AKI, active bleeding, severe anemia, thrombocytopenia/coagulopathy, uncontrolled hypertension, infection, and inability to lie flat or cooperate.
- Severe aortic stenosis, severe peripheral arterial disease, complex aortic disease, and prior CABG can change procedural approach and risk.
- Pregnancy requires a multidisciplinary, radiation- and contrast-minimizing plan.

### Pre-cath APP safety check

1. Confirm indication, urgency, allergies/contrast-reaction history, informed-consent status when feasible, and code status/goals of care.
2. Document baseline symptoms, ECG, focused neurologic exam, access-site skin/pulses, hemoglobin/platelets, creatinine/eGFR, and type-and-screen when bleeding risk is material.
3. Reconcile anticoagulants, antiplatelets, insulin/diabetes medications, and nephrotoxins. Do **not** independently hold a P2Y12 inhibitor after recent PCI; contact interventional cardiology.
4. Establish IV access and appropriate monitoring; optimize oxygenation, blood pressure, pain/anxiety, and shock before transport when this does not delay emergent reperfusion.
5. For kidney-risk patients, use the operator/local protocol for contrast minimization and individualized isotonic-volume strategy; avoid uncritical fluid loading in decompensated HF.
...
| Finding | Meaning | Usual next step |
| --- | --- | --- |
| Culprit occlusion/thrombotic severe stenosis in ACS | Likely source of acute ischemia | Immediate PCI when appropriate; initiate and protect antiplatelet plan. |
| Intermediate lesion | Angiography alone may over- or under-estimate physiologic significance. | Use physiology and/or intravascular imaging when appropriate. |
| Multivessel CAD | Revascularization strategy depends on clinical presentation, anatomy, ventricular function, diabetes, surgical candidacy, and patient preferences. | Heart-team discussion is particularly important for complex left-main or multivessel disease. |
| Nonobstructive coronaries in an ACS presentation | Does not exclude myocardial infarction or ischemia. | Evaluate for MINOCA mechanisms, spasm, spontaneous coronary artery dissection, myocarditis, takotsubo, or supply-demand mismatch with cardiology. |
...
| Medication | Common adult ACS PCI regimen | Safety points |
| --- | --- | --- |
| Aspirin | Loading dose **162–325 mg** when not already given; maintenance is generally **75–100 mg daily**. | Secondary-prevention aspirin is usually continued; bleeding decisions require cardiology and proceduralist input. |
| Clopidogrel | **300–600 mg** loading dose, then **75 mg daily**. | Variable response; often selected when a more potent P2Y12 inhibitor is unsuitable. |
| Ticagrelor | **180 mg** loading dose, then **90 mg twice daily** during the first year after ACS. | Dyspnea and bradyarrhythmia can occur; avoid maintenance aspirin doses above 100 mg/day. |
| Prasugrel | **60 mg** loading dose, then **10 mg daily**; use **5 mg daily** in patients <60 kg. | Contraindicated with prior stroke/TIA; generally avoid in age ≥75 unless high ischemic risk and low bleeding risk. |

The 2025 ACS guideline uses aspirin plus an oral P2Y12 inhibitor for **at least 12 months** as the default ACS strategy for patients who are not at high bleeding risk. Individualize duration, de-escalation, and any interruption with the interventional cardiologist, particularly after complex PCI or a recent ACS.

### Anticoagulation and other adjuncts

| Class | Role | Handoff implication |
| --- | --- | --- |
| Unfractionated heparin or bivalirudin | Procedural anticoagulation is selected by the interventional operator and clinical context. | Confirm stop time, ACT strategy if relevant, and whether a post-procedure infusion is intentionally ordered. |
| GP IIb/IIIa inhibitor | Selective rescue/bailout therapy for high thrombus burden or no-reflow; not routine for all PCI. | Heightened surveillance for bleeding and thrombocytopenia; verify infusion stop time. |
| High-intensity statin | Recommended for ACS unless contraindicated. | Verify that high-intensity therapy is ordered before discharge and that lipid plan is documented. |
...
| Domain | What to assess | Escalate urgently for |
| --- | --- | --- |
| Ischemia | Recurrent chest pain, diaphoresis, dyspnea, new ECG changes, rhythm. | Recurrent ST elevation/depression, sustained VT/VF, new shock, or refractory chest pain. |
| Access site | Dressing/band, hematoma size/tension, bleeding, distal color/warmth/capillary refill/pulses, paresthesia/pain. | Expanding hematoma, persistent bleeding, ischemic hand/leg, new severe groin/back/flank pain, or hypotension. |
| Hemodynamics | BP/HR, perfusion, oxygenation, urine output, mental status. | Hypotension, rising vasopressor need, pulmonary edema, or signs of tamponade. |
| Renal/contrast | Creatinine trend when clinically indicated; urine output and volume status. | Oliguria/AKI, especially with congestion or shock; coordinate fluid and diuretic decisions. |
| Antithrombotics | Aspirin/P2Y12 administration and next-dose schedule; bleeding signs. | Missed P2Y12 dose, active bleeding, unexpected hemoglobin fall, or urgent procedure request. |

### Post-PCI transfer checklist

- [ ] Indication, culprit vessel, intervention performed, final flow, residual disease, and complication status documented.
- [ ] Access site/laterality, closure plan, bed-rest or radial-band instructions, and pulse/neurovascular baseline recorded.
- [ ] Aspirin and P2Y12 agent, load time, next dose, and intended DAPT plan verified.
- [ ] Procedural anticoagulant/adjuncts and any infusion stop time reconciled.
- [ ] ECG and symptom trajectory compared with pre-procedure status.
...
3. Naidu SS, Abbott JD, Bagai J, et al. SCAI Expert Consensus Update on Best Practices in the Cardiac Catheterization Laboratory. *Catheter Cardiovasc Interv*. 2021;98(2):255-276. doi:10.1002/ccd.29744. [SCAI statement](https://www.scai.org/publications/clinical-documents/scai-expert-consensus-update-best-practices-cardiac-catheterization)
4. Abbott JD, Al-Azizi K, Barman N, et al. SCAI Expert Consensus Statement on the Management of Patients With STEMI Referred for Primary PCI. *JSCAI*. 2024;3(11):102294. doi:10.1016/j.jscai.2024.102294. PMID: 39649824. [Statement](https://www.scai.org/publications/clinical-documents/scai-expert-consensus-statement-management-patients-stemi-referred)
5. Virani SS, Newby LK, Arnold SV, et al. 2023 AHA/ACC/ACCP/ASPC/NLA/PCNA Guideline for the Management of Patients With Chronic Coronary Disease. *Circulation*. 2023;148(9):e9-e119. doi:10.1161/CIR.0000000000001168. [Guideline](https://www.ahajournals.org/doi/10.1161/CIR.0000000000001168)
6. Brilakis ES, Mashayekhi K, Tsuchikane E, et al. Guiding Principles for Chronic Total Occlusion Percutaneous Coronary Intervention. *Circulation*. 2019;140(5):420-433. doi:10.1161/CIRCULATIONAHA.119.039797. PMID: 31356129.

**PubMed search terms used:** `left heart catheterization PCI complications`; `2025 ACC AHA acute coronary syndrome guideline PCI`; `2021 ACC AHA SCAI coronary revascularization`; `SCAI cardiac catheterization laboratory best practices`; `SCAI STEMI primary PCI consensus`.
